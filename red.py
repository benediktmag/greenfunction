...
def drawGeorge( n, Q = lambda z: 0*z, K = regionPoints(), show = True, save = True ):
	'''
...
def drawGreen( n, Q = lambda z: 0*z, K = regionPoints(), show = True, save = True ):
	'''
